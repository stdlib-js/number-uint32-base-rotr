...
```javascript
import rotr32 from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint32-base-rotr@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/number-uint32-base-rotr/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/number-uint32-base-rotr/actions/workflows/test.yml?query=branch:v0.2.3
